...
public class AuthorRecord extends UpdatableRecordImpl<AuthorRecord> implements Record6<Integer, String, String, Date, Integer, Short> {

    private static final long serialVersionUID = 1007180966;
     ...
     */
    public void setDistinguished(Short value) {
        set(5, value);
    }
     ...
     */
    @Override
    public Row6<Integer, String, String, Date, Integer, Short> fieldsRow() {
     ...
     */
    @Override
    public Row6<Integer, String, String, Date, Integer, Short> valuesRow() {
     ...
     */
    @Override
    public AuthorRecord value6(Short value) {
     ...
     */
    @Override
    public AuthorRecord values(Integer value1, String value2, String value3, Date value4, Integer value5, Short value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AuthorRecord(Integer id, String firstName, String lastName, Date dateOfBirth, Integer yearOfBirth, Short distinguished) {
        super(Author.AUTHOR);
